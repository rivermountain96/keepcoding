...
<body>
  ...
  <header class="header_wrap">
    <div class="nav nav-tabs container d-flex justify-content-between">
      <!-- 로고 시작 -->
        <h1 class="main_logo"><a href="/keepcoding/main/index.html"><span>keep coding</span></a></h1>
      <!-- 로고 끝 -->
      
      <!-- 메뉴 시작 -->
        <ul class="nav d-flex col-4 justify-content-between nav_menu">
          <li class="nav-item dropdown">
            <a class="dropdown-toggle h5" data-bs-toggle="dropdown" href="/keepcoding/main/product/product_shop_list.html" role="button" aria-expanded="false">강의탐색</a>
            <ul class="dropdown-menu nav_dropdown shadow-sm">
              <li class="fs-6"><a class="dropdown-item fs-6" href="/keepcoding/main/product/product_shop_list.html">프론트엔드</a></li>
              <li><hr></li>
              <li><a class="dropdown-item fs-6" href="/keepcoding/main/product/product_shop_list.html">백엔드</a></li>
              <li><hr></li>
              <li><a class="dropdown-item fs-6" href="/keepcoding/main/product/product_shop_list.html">기초강의</a></li>
            </ul>
          </li>
      ...
      <!-- 장바구니,로그인 시작 -->
        <ul class="nav nav-login">
          <li class="nav-item item_cart"><a class="fs-6" href="/keepcoding/main/cart/cart.html">장바구니</a></li>
          <li class="nav-item"><a class="fs-6" href="/keepcoding/main/login.html">로그인</a></li>
          <!-- <li class="nav-item"><a class="fs-6" href="../mypage/myproduct_list.html">아이디</a></li> -->
          <li class="nav-item"><a class="fs-6" href="/keepcoding/main./signup.html">회원가입</a></li>
