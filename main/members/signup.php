...
?>
  ...
  <div id="myModal" class="modal_create">
    <div class="modal-content">
      ...
      <p><span>KEEP CODING 학습사이트</span>에서는 회원 가입 및 학습사이트의 홍보를 위해 귀하의 개인정보를 수집,이용하고자 하오니
        다음의 내용을 충분히 검토하신 후 동의 여부를 결정해 주시기 바랍니다.</p>
      <hr>
      ...
      <hr>
      <div class="middle_agree_btn d-flex justify-content-center">
        <button id="agreeButton" class="btn btn-primary">동의합니다</button>
      </div>
    </div>
  </div>
