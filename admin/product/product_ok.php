...
try{
  ...
  (name, cate, content, thumbnail, price, sale_price, sale_cnt, isnew, isrecom, userid, sale_end_date, reg_date, file_table_id)
  VALUES
  ('{$name}', '{$cate}', '{$content}', '{$thumbnail}', '{$price}', '{$sale_price}', {$sale_cnt}, '{$isnew}', '{$isrecom}', '{$_SESSION['AUID']}', '{$sale_end_date}', now(), '{$file_table_id}')";
