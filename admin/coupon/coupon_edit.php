  ...
  <form action="coupon_edit_ok.php" method="post" enctype="multipart/form-data">
      ...
      <div class="coupon_up_status d-flex row col-4">
        ...
        <div class="coupon_up_status_checkbox d-flex">
          ...
          <div class="coupon_up_status_off form-check text-center">
            <input class="coupon_up_status_input form-check-input" type="radio" value="0" name="status" id="status0" checked>
          ...
          ?>
          <div class="coupon_up_status_on form-check">
            <input class="coupon_up_status_input form-check-input" type="radio" value="1" name="status" id="status1" checked>
            <label class="form-check-lsabel" for="status1">활성화</label>
          </div>
          <div class="coupon_up_status_off form-check text-center">
            <input class="coupon_up_status_input form-check-input" type="radio" value="0" name="status" id="status0">
            <label class="form-check-label" for="status0">비활성화</label>
          </div>
          <?php
            }
    ...
    <div class="pd48">
      <div class="coupon_up_image">
        ...
        <input class="form-control form-control-lg mb-5" name="coupon_image" id="coupon_image" type="file">
      </div>
    </div>
    <?php
      }
