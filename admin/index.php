...
<div class="content">
  ...
  <div class="member row pd48 gap-4">
    <div class="col kcard d-flex align-items-center justify-content-center">
      <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-file-person pc" viewBox="0 0 16 16">
    ...
    <div class="col kcard d-flex align-items-center justify-content-center">
      <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-award pc" viewBox="0 0 16 16">
